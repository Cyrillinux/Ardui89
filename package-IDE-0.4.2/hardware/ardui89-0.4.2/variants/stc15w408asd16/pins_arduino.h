 ...
 * STC15W408AS-DIP16
 * Last revision : 2026/05/12 : 0.4.2
 */
...
__sfr __at (0xBA) P_SW2; // Registre de sélection de fonction périphérique 2
...
/* Déclarations des registres STC15 pour SDCC */
__sfr __at (0xBC) ADC_CONTR; // Adresse du registre de contrôle ADC
__sfr __at (0xBD) ADC_RES;   // Résultat ADC (8 bits de poids fort)
__sfr __at (0xBE) ADC_RESL;  // Résultat ADC (2 bits de poids faible)
__sfr __at (0xAD) ADCCFG;    // Configuration de la vitesse ADC
__sfr __at (0x9D) P1ASF; // Définition de l'adresse du registre pour SDCC
