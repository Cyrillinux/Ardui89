...
pythonRootPath=""+site.getsitepackages()[0]+"/"
serialPkgPath=""+site.getsitepackages()[0]+"/pyserial-3.5-py3.8.egg"
serialSetupFile = Path(serialPkgPath)
stcflashispPath=pythonRootPath+"../../stcflashisp/"+VERSION+"/bin"
os.chdir(stcflashispPath)
print("Check : "+serialPkgPath)
if serialSetupFile.is_file():
    print("Serial Python module installed.")
else:
    print("Install Serial Python module...")
    print("Python Root Path : "+pythonRootPath)
    os.system(pythonRootPath+"python3 ./setup_serial.py install");

os.chdir(pythonRootPath)
sys.path.append(pythonRootPath+'/lib/site-packages')
print(sys.path)
import serial
