...
struct _89_uart _Serial;

//_89_uart__Serial_struct_link
void Serial89Init (void) {
    if (_Serial.begin!=NULL) return;
    _Serial.available=&_89_uart_available;
    _Serial.begin=&_89_uart_begin;
    _Serial.printf=&_89_uart_printf;
    _Serial.print=&_89_uart_printf;
    _Serial.printfln=&_89_uart_printfln;
    _Serial.println=&_89_uart_printfln;
    _Serial.read=&_89_uart_read_char;
}
// _89_uart_init
